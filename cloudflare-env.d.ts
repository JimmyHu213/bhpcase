/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: a2acbf28bd1a97253ffcfe87c3b8e368)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		ASSETS: Fetcher;
		ADMIN_NOTIFICATION_EMAIL: "info@unhappybanking.com.au";
		NEXTJS_ENV: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_NOTIFICATION_EMAIL" | "NEXTJS_ENV" | "ADMIN_USERNAME" | "ADMIN_PASSWORD" | "RESEND_API_KEY" | "AUTH_SECRET">> {}
}
